/**
 * Случайное целое число из положительного диапазона, включая ноль (min; max).
...
/**
 * Случайное число из с плавающей точкой из положительного диапазона включительно, включая ноль (min; max).
 * Если значение "до" меньше или равно значению "от", то "Неверный диапазон".
